...
public class ActivityController {
	...
	public ResponseEntity<?> assignRoles(@RequestParam("userId") String userId, @Valid @RequestBody RoleDTO roleDTO, Authentication authentication) throws NoDataFoundException {
	...
	public ResponseEntity<?> revokeRoles(@RequestParam("userId") String userId, @Valid @RequestBody RoleDTO roleDTO, Authentication authentication) throws NoDataFoundException {
